...
cp ./sessionID.php php/sessionID.php
...
cp jquery.popupwindow.js ./php/smi/jscript/jquery/
#cp ./ez_sql_mysqli.php php/smi/classes/ezSQL/mysqli/ez_sql_mysqli.php
#cp ./log.php php/smi/log.php
mkdir php/lng/
